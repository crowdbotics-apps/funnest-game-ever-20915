"""funnest_game_ever_20915 URL Configuration
...
admin.site.site_header = "Funnest Game Ever"
admin.site.site_title = "Funnest Game Ever Admin Portal"
admin.site.index_title = "Funnest Game Ever Admin"

# swagger
api_info = openapi.Info(
    title="Funnest Game Ever API",
    default_version="v1",
    description="API documentation for Funnest Game Ever App",
)
